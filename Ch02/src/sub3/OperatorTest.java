...
public class OperatorTest {
	public static void main(String[] args) {
		...
		boolean res5 = val1 == val2; // val1이 val2와 서로 같다.
		boolean res6 = val1 != val2; // val1이 val2와 서로 다르다.
		...
		// 논리 연산자
		boolean result1 = (val1 > 1) && (val2 < 3); // val1은 1보다 크다 그리고 val2는 3보다 작다.
		boolean result2 = (val1 > 0) && (val2 < 3); // val1은 0보다 크다 그리고 val2는 3보다 작다.
		boolean result3 = (val1 > 1) || (val2 < 3); // val1은 1보다 크다 또는 val2는 3보다 작다. 
